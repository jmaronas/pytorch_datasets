...
from cars import cars_standford,bbox_cars_standford

dataset = cars_standford('./data/','train',image_shape=200,download=True,transform=tvtr.ToTensor())
...
dataset = bbox_cars_standford('./data/','train',download=True,transform=tvtr.ToTensor())
