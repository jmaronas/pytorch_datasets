...
class cars_standford(ImageFolder):
	...
	def _check_if_process(self):
		...
		if not os.path.isfile(path_file):
			raise Exception("You seem to already have a folder named {} where processing did not succed. Erase folder {} and re-run".format(self.processed_directory,os.path.join('cars_images_processed',str(self.image_shape),self.interpolation,self.padding)))	
